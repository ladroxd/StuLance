...
# ... (rest of settings unchanged — copy this file to settings.py and configure your .env)
...
# Set USE_LOCAL_DB=1 in .env to use SQLite instead of MySQL
if config('USE_LOCAL_DB', default='0') == '1':
    DATABASES = {
        'default': {
